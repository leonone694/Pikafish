...
constexpr int DARKRISK_MIN_FACTOR = 2; // Maximum risk reduction: adjustedDiff = DARKMAXDIFF / 2
constexpr int DARKRISK_MAX_FACTOR = 3; // Maximum risk increase: adjustedDiff = DARKMAXDIFF * 3 / 2
...
enum Piece {
  ...
  //����
  BW_ROOK = W_ROOK + 16, BW_ADVISOR, BW_CANNON, BW_PAWN, BW_KNIGHT, BW_BISHOP,
  BB_ROOK = B_ROOK + 16, BB_ADVISOR, BB_CANNON, BB_PAWN, BB_KNIGHT, BB_BISHOP,
  PIECE_NB = 32
};
...
constexpr PieceType BPiece[45]{
    ROOK, KNIGHT, BISHOP, ADVISOR, NO_PIECE_TYPE, ADVISOR, BISHOP, KNIGHT, ROOK,
    NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE,
    NO_PIECE_TYPE, CANNON, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, CANNON, NO_PIECE_TYPE,
    PAWN, NO_PIECE_TYPE, PAWN, NO_PIECE_TYPE, PAWN, NO_PIECE_TYPE, PAWN, NO_PIECE_TYPE, PAWN,
    NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE, NO_PIECE_TYPE,
};
enum Direction : int {
  NORTH =  9,
...
constexpr Dark operator~(Dark d) {
